...
export default function Home() {
  ...
  return <div className="page-in">
    <section className="relative isolate min-h-[520px] overflow-hidden border-b border-white/[.08] lg:min-h-[560px]">
      ...
      <div className="absolute right-[14%] top-[24%] -z-10 h-40 w-40 rounded-full bg-[#2ac47f]/10 blur-3xl" />
      <div className="mx-auto flex min-h-[520px] max-w-[1280px] flex-col justify-end px-5 pb-14 pt-16 sm:px-10 lg:min-h-[560px] lg:flex-row lg:items-end lg:justify-between lg:gap-10 lg:px-12 lg:pb-16">
        <div className="max-w-[670px]">
          <div className="hero-reveal inline-flex items-center gap-2 rounded-full border border-[#2ac47f]/25 bg-[#0e1210]/45 px-3 py-1.5 text-[10px] font-semibold uppercase tracking-[.16em] text-[#8bd5b5] backdrop-blur"><Sparkles size={12} /> A living city map · Bengaluru</div>
