    ...
    <div className="min-h-screen bg-[#0e1210] text-[#f3f3e8]">
      ...
      <header className="fixed left-0 right-0 top-0 z-30 flex h-[70px] items-center justify-between border-b border-white/[.08] bg-[#0e1210]/85 px-5 backdrop-blur-xl lg:left-[246px] lg:px-8">
        ...
        <div className="ml-auto flex items-center gap-3">
          <div className="hidden items-center gap-2 rounded-full border border-[#ff8a2b]/20 bg-[#ff8a2b]/[.06] px-3 py-1.5 text-[11px] text-[#87d4b4] sm:flex"><span className="h-1.5 w-1.5 rounded-full bg-[#ff8a2b] shadow-[0_0_8px_rgba(255,138,43,.8)]" /> Live data</div>
